	...
	const [messages, setMessages] = useState([
		{
			id: 1,
			from: 'seller',
			text: 'Xin chào, vui lòng thanh toán trong 24h',
			time: '10:30',
		},
		{
			id: 2,
			from: 'buyer',
			text: 'Vâng, tôi sẽ chuyển khoản ngay',
			time: '10:35',
		},
	])
						...
						<Card>
							...
							<CardContent className="space-y-4">
								...
								{step === 3 && (
									<>
										<p className="text-muted-foreground">
											Đang chờ người mua xác nhận đã nhận
											hàng
										</p>
